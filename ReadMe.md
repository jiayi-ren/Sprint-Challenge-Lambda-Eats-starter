...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    'useRouteMatch' allows to add nested routes to the application such that only specific parameter change is necessary instead of changing the whole thing.    

2. How would you explain form validation to someone who has never programmed before?

    Form validation is a process to simulate and alert every possible user input error. In the meantime, make suggestion for users to proceed with application.

3. In 1-2 sentences, define end to end testing.

    End to end testing is a testing process that mimic how a user might interact with an app within all possible interactive events.
